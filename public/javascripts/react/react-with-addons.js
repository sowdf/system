...
var DOMPropertyInjection = {
  ...
  /**
   * Inject some specialized knowledge about the DOM. This takes a conf object
   ...
   *
   * @param {object} domPropertyConfig the conf as described above.
   */
  injectDOMPropertyConfig: function (domPropertyConfig) {
    ...
    for (var propName in Properties) {
      !!DOMProperty.properties.hasOwnProperty(propName) ? "development" !== 'production' ? invariant(false, 'injectDOMPropertyConfig(...): You\'re trying to inject DOM property ' + '\'%s\' which has already been injected. You may be accidentally ' + 'injecting the same DOM property conf twice, or you may be ' + 'injecting two configs that have conflicting property names.', propName) : invariant(false) : undefined;
...
var EventPluginRegistry = {
  ...
  /**
   * Mapping from event name to dispatch conf
   */
